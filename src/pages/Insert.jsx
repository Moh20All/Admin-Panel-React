...
const MyForm = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://127.0.1.1:3000/approve-user', {
                method: 'POST',
                headers: {
    ...
    return (
      ...
      <div className="mb-4">
        ...
        <input type="password" id="password" name="password" value={formData.password} onChange={handleChange} className="w-full border border-gray-300 rounded-md px-4 py-2" />
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4">
        <label htmlFor="carteGrise" className="block font-semibold">Carte Grise</label>
        <input type="text" id="carteGrise" name="carteGrise" value={formData.carteGrise} onChange={handleChange} className="w-full border border-gray-300 rounded-md px-4 py-2" />
      </div>
      <div className="mb-4">
